...
use Winter\Mall\Classes\Feeds\GoogleMerchantFeed;
use Winter\Mall\Models\FeedSettings;

// Send virtual product files to the user's browser.
Route::get('/mall/download/{key}', '\Winter\Mall\Classes\Downloads\VirtualProductFileDownload@handle')
     ->middleware('web');
...
//
// @see \Winter\Mall\Classes\Payments\PaymentRedirector::handlePaymentResult
